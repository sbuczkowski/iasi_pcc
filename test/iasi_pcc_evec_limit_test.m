...
for ne=1:89
    ...
    for band=1:3
        ...
        % convert to brightness temperature and find difference to
        % full spectrum
        spectrum = 1;
...
ylabel('BT residual mean (K)');
xlabel('# of eigenvectors in reconstruction')
title('IASI PCC reconstruction (# eigenvector sensitivity)')
